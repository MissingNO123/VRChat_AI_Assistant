...
# adjust this to set the minimum volume threshold to start/stop recording
THRESHOLD = 1024
...
# List of messages sent back and forth between ChatGPT / User, initialized with example messages
messageArr = []
...
ip = "127.0.0.1"  # IP and Port for VRChat OSC
inPort = 9000
outPort = 9001
...
def old_whisper_transcribe():
    ...
    if result.no_speech_prob > 0.5:
        ...
        print(f"U: {result.no_speech_prob*100:.1f}%")
...
def handle_command(command):
    ...
    match command:
        case 'reset':
            messageArr = []  # List of messages sent back and forth between ChatGPT / User
...
def load_whisper():
    ...
    # model = whisper.load_model(whisper_model, device, in_memory=True)
